...
if %choice"=="2" (
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://dagnall53.github.io/MarineMultiDisplay/build/esp32.esp32.esp32s3/WAVMMD.ino.bin', 'MarineMultiDisplay.ino.bin')")
if %choice"=="1" (
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://dagnall53.github.io/MarineMultiDisplay/build/esp32.esp32.esp32s3/GUITMMD.ino.bin', 'MarineMultiDisplay.ino.bin')")
